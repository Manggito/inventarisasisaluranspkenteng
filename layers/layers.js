...
lyr_GoogleSatelliteHybrid_0.setVisible(false);lyr_GoogleRoads_1.setVisible(false);lyr_GoogleSatellite_2.setVisible(true);lyr_OpenTopoMap_3.setVisible(false);lyr_Sungai_4.setVisible(true);lyr_Jalan_5.setVisible(true);lyr_AreaFungsional_6.setVisible(true);lyr_JalurPipa_7.setVisible(true);lyr_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_8.setVisible(true);lyr_JENIS_SALURAN_9.setVisible(true);lyr_AREANOMENKLATUR_10.setVisible(true);lyr_BANGUNANNOMENKLATUR_11.setVisible(true);lyr_Tikungan_12.setVisible(true);lyr_Beda_Pasangan_13.setVisible(true);lyr_Gorong__Gorong_14.setVisible(true);lyr_Titik_Per_50_m_15.setVisible(true);lyr_Box_Gate_Valve_16.setVisible(true);lyr_Box_Alva_Valve_17.setVisible(true);lyr_Bangunan_Air_18.setVisible(true);lyr_Bangunan_Bagi_19.setVisible(true);lyr_Bangunan_Sadap_20.setVisible(true);lyr_Rumah_Pompa_21.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_GoogleRoads_1,lyr_GoogleSatellite_2,lyr_OpenTopoMap_3,lyr_Sungai_4,lyr_Jalan_5,lyr_AreaFungsional_6,lyr_JalurPipa_7,lyr_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_8,lyr_JENIS_SALURAN_9,group_SKEMANOMENKLATUR,group_TITIKKETERANGAN,group_TITIKAKSESSORIS];
...
lyr_AreaFungsional_6.set('fieldLabels', {'Id': 'hidden field', 'AREA': 'inline label - visible with data', 'LUAS': 'inline label - visible with data', 'SATUAN': 'hidden field', });
