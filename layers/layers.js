...
var format_JALUR_PIPA_4 = new ol.format.GeoJSON();
var features_JALUR_PIPA_4 = format_JALUR_PIPA_4.readFeatures(json_JALUR_PIPA_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_JALUR_PIPA_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_JALUR_PIPA_4.addFeatures(features_JALUR_PIPA_4);
var lyr_JALUR_PIPA_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_JALUR_PIPA_4, 
                style: style_JALUR_PIPA_4,
                popuplayertitle: 'JALUR_PIPA',
                interactive: true,
                title: '<img src="styles/legend/JALUR_PIPA_4.png" /> JALUR_PIPA'
            });
var format_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5 = new ol.format.GeoJSON();
var features_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5 = format_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5.readFeatures(json_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5.addFeatures(features_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5);
var lyr_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5, 
                style: style_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5,
                popuplayertitle: 'KETERANGAN_KERUSAKAN_SALURAN_ANYARR',
                interactive: true,
    title: 'KETERANGAN_KERUSAKAN_SALURAN_ANYARR<br />\
    <img src="styles/legend/KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5_0.png" /> Baik<br />\
    <img src="styles/legend/KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5_1.png" /> Rusak Ringan<br />\
    <img src="styles/legend/KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5_2.png" /> Rusak Sedang<br />\
    <img src="styles/legend/KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5_3.png" /> Rusak Berat<br />' });
...
var group_TITIKAKSESSORIS = new ol.layer.Group({
                                layers: [lyr_Box_Gate_Valve_11,lyr_Box_Alva_Valve_12,lyr_Bangunan_Air_13,lyr_Bangunan_Bagi_14,lyr_Bangunan_Sadap_15,lyr_Rumah_Pompa_16,],
                                fold: 'open',
...
lyr_GoogleSatellite_0.setVisible(true);lyr_SUNGAI_1.setVisible(true);lyr_JALAN_2.setVisible(true);lyr_AREAFUNGSIONAL_3.setVisible(true);lyr_JALUR_PIPA_4.setVisible(true);lyr_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5.setVisible(true);lyr_JENIS_SALURAN_6.setVisible(true);lyr_Tikungan_7.setVisible(true);lyr_Beda_Pasangan_8.setVisible(true);lyr_Gorong__Gorong_9.setVisible(true);lyr_Titik_Per_50_m_10.setVisible(true);lyr_Box_Gate_Valve_11.setVisible(true);lyr_Box_Alva_Valve_12.setVisible(true);lyr_Bangunan_Air_13.setVisible(true);lyr_Bangunan_Bagi_14.setVisible(true);lyr_Bangunan_Sadap_15.setVisible(true);lyr_Rumah_Pompa_16.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_SUNGAI_1,lyr_JALAN_2,lyr_AREAFUNGSIONAL_3,lyr_JALUR_PIPA_4,lyr_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5,lyr_JENIS_SALURAN_6,group_TITIKKETERANGAN,group_TITIKAKSESSORIS];
...
lyr_JALUR_PIPA_4.set('fieldAliases', {'Id': 'Id', });
lyr_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5.set('fieldAliases', {'Id': 'Id', 'JENIS': 'JENIS', 'KATEGORI': 'KATEGORI', 'KETERANGAN': 'KETERANGAN', 'PANJANG': 'PANJANG', });
...
lyr_Gorong__Gorong_9.set('fieldAliases', {'NAME': 'NAME', 'pdfmaps_ph': 'pdfmaps_ph', 'Descriptio': 'Descriptio', 'X': 'X', 'Y': 'Y', 'BUJUR': 'BUJUR', 'LINTANG': 'LINTANG', 'PANJANG': 'PANJANG', 'FOTO_1': 'FOTO_1', 'FOTO_2': 'FOTO_2', 'FOTO_3': 'FOTO_3', 'FOTO_4': 'FOTO_4', 'FOTO_5': 'FOTO_5', 'FOTO_6': 'FOTO_6', 'FOTO_7': 'FOTO_7', 'FOTO_8': 'FOTO_8', });
...
lyr_Box_Gate_Valve_11.set('fieldAliases', {'NAME': 'NAME', 'pdfmaps_ph': 'pdfmaps_ph', 'Descriptio': 'Descriptio', 'X': 'X', 'Y': 'Y', 'BUJUR': 'BUJUR', 'LINTANG': 'LINTANG', 'PANJANG': 'PANJANG', 'FOTO_1': 'FOTO_1', 'FOTO_2': 'FOTO_2', 'FOTO_3': 'FOTO_3', 'FOTO_4': 'FOTO_4', 'FOTO_5': 'FOTO_5', 'FOTO_6': 'FOTO_6', 'FOTO_7': 'FOTO_7', 'FOTO_8': 'FOTO_8', });
lyr_Box_Alva_Valve_12.set('fieldAliases', {'NAME': 'NAME', 'pdfmaps_ph': 'pdfmaps_ph', 'Descriptio': 'Descriptio', 'X': 'X', 'Y': 'Y', 'BUJUR': 'BUJUR', 'LINTANG': 'LINTANG', 'PANJANG': 'PANJANG', 'FOTO_1': 'FOTO_1', 'FOTO_2': 'FOTO_2', 'FOTO_3': 'FOTO_3', 'FOTO_4': 'FOTO_4', 'FOTO_5': 'FOTO_5', 'FOTO_6': 'FOTO_6', 'FOTO_7': 'FOTO_7', 'FOTO_8': 'FOTO_8', });
...
lyr_JALUR_PIPA_4.set('fieldImages', {'Id': 'Range', });
lyr_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5.set('fieldImages', {'Id': 'Range', 'JENIS': 'TextEdit', 'KATEGORI': 'TextEdit', 'KETERANGAN': 'TextEdit', 'PANJANG': 'TextEdit', });
...
lyr_Gorong__Gorong_9.set('fieldImages', {'NAME': 'TextEdit', 'pdfmaps_ph': 'TextEdit', 'Descriptio': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'BUJUR': 'TextEdit', 'LINTANG': 'TextEdit', 'PANJANG': 'TextEdit', 'FOTO_1': 'ExternalResource', 'FOTO_2': 'ExternalResource', 'FOTO_3': 'ExternalResource', 'FOTO_4': 'ExternalResource', 'FOTO_5': 'ExternalResource', 'FOTO_6': 'ExternalResource', 'FOTO_7': 'ExternalResource', 'FOTO_8': 'ExternalResource', });
...
lyr_Box_Alva_Valve_12.set('fieldImages', {'NAME': 'TextEdit', 'pdfmaps_ph': 'TextEdit', 'Descriptio': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'BUJUR': 'TextEdit', 'LINTANG': 'TextEdit', 'PANJANG': 'TextEdit', 'FOTO_1': 'ExternalResource', 'FOTO_2': 'ExternalResource', 'FOTO_3': 'ExternalResource', 'FOTO_4': 'ExternalResource', 'FOTO_5': 'ExternalResource', 'FOTO_6': 'ExternalResource', 'FOTO_7': 'ExternalResource', 'FOTO_8': 'ExternalResource', });
...
lyr_JALUR_PIPA_4.set('fieldLabels', {'Id': 'hidden field', });
lyr_KETERANGAN_KERUSAKAN_SALURAN_ANYARR_5.set('fieldLabels', {'Id': 'hidden field', 'JENIS': 'hidden field', 'KATEGORI': 'inline label - visible with data', 'KETERANGAN': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', });
...
lyr_Gorong__Gorong_9.set('fieldLabels', {'NAME': 'inline label - visible with data', 'pdfmaps_ph': 'hidden field', 'Descriptio': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'BUJUR': 'inline label - visible with data', 'LINTANG': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', 'FOTO_1': 'no label', 'FOTO_2': 'no label', 'FOTO_3': 'no label', 'FOTO_4': 'no label', 'FOTO_5': 'no label', 'FOTO_6': 'no label', 'FOTO_7': 'no label', 'FOTO_8': 'no label', });
...
lyr_Box_Gate_Valve_11.set('fieldLabels', {'NAME': 'inline label - visible with data', 'pdfmaps_ph': 'hidden field', 'Descriptio': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'BUJUR': 'inline label - visible with data', 'LINTANG': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', 'FOTO_1': 'no label', 'FOTO_2': 'no label', 'FOTO_3': 'no label', 'FOTO_4': 'no label', 'FOTO_5': 'no label', 'FOTO_6': 'no label', 'FOTO_7': 'no label', 'FOTO_8': 'no label', });
lyr_Box_Alva_Valve_12.set('fieldLabels', {'NAME': 'inline label - visible with data', 'pdfmaps_ph': 'hidden field', 'Descriptio': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'BUJUR': 'inline label - visible with data', 'LINTANG': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', 'FOTO_1': 'no label', 'FOTO_2': 'no label', 'FOTO_3': 'no label', 'FOTO_4': 'no label', 'FOTO_5': 'no label', 'FOTO_6': 'no label', 'FOTO_7': 'no label', 'FOTO_8': 'no label', });
