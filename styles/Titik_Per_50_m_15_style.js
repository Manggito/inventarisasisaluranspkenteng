...
var style_Titik_Per_50_m_15 = function(feature, resolution){
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 6.4 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.76}), fill: new ol.style.Fill({color: 'rgba(255,0,0,1.0)'})}),
